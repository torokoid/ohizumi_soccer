...
<body onload="alert('サッカー部　OB会の記録〜〜(^o^)/')" onunload="alert('再会の時まで、元気でお過ごしくださいませ〜(^o^)/')">

<h1><span class="yellow"><marquee behavior="alternate">!!! 大泉高校、サッカー部 OB会 2019/04/07 !!!</marquee></span></h1>
...
<!-- フッタ -->
 <footer>
 <span class="white">Copyright 2019/04/18 Pe-Young(S.Hada)</span>
 </footer>
